...
class DizilabProvider : MainAPI() {
    ...
    override var mainUrl = "https://dizilab.to"
    ...
    private suspend fun getUrl(): String {
        return DynamicDomainHelper.getActiveDomain("dizilab", fallbackDomains)
    }
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        val home = doc.select("div.poster, div.dizi-box, article, div.item").mapNotNull {
            it.toSearchResult()
        }
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        ...
        return doc.select("div.poster, div.dizi-box, article, div.search-result").mapNotNull {
            it.toSearchResult()
        }
    }
